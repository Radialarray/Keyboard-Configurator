...
[![Build Status](https://img.shields.io/github/actions/workflow/status/svenlochner/keyboard-configurator/ci.yml?branch=main&style=flat-square)](https://github.com/svenlochner/keyboard-configurator/actions)
[![License](https://img.shields.io/badge/license-MIT-blue?style=flat-square)](LICENSE)
[![Rust Version](https://img.shields.io/badge/rust-1.75%2B-orange?style=flat-square)](https://www.rust-lang.org)
[![v0.4.0](https://img.shields.io/badge/version-0.4.0-green?style=flat-square)](https://github.com/svenlochner/keyboard-configurator/releases)
...
### From Source
```bash
git clone --recursive https://github.com/svenlochner/keyboard-configurator.git lazyqmk
cd lazyqmk
cargo install --path .
```
